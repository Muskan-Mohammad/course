...
const SingleCoursePage = () => {
  ...
  console.log(single_course , "course")
  useEffect(() => {
    fetchSingleCourse(id);
  }, []);

  const {id: courseID, category, image, course_name, description,  creator, lang, discounted_price, what_you_will_learn: learnItems, content 
    ,prerequisites ,duration ,enrollmentStatus , schedule,location 
  } = single_course;
        ...
        <div className='course-details'>
          ...
          <div className='course-body'>
            ...
            <div className='course-rating flex'>
              <span className='students-count fs-14'>Duration : {duration}</span>
              <span className='students-count fs-14'> Enrollment-Status : {enrollmentStatus}</span>
            </div>

            <ul className='course-info'>
              <li>
                <span className='fs-14'>Instructor <span className='fw-6 opacity-08'>{creator}</span></span>
              </li>
              <li className='flex'>
                <span><MdInfo /></span>
                <span className='fs-14 course-info-txt fw-5'>Pre-Requisites : {prerequisites}</span>
              </li>
              <li className='flex'>
                <span><TbWorld /></span>
                <span className='fs-14 course-info-txt fw-5'>Mode : {location}</span>
              </li>
              <li className='flex'>
                <span><RiClosedCaptioningFill /></span>
                <span className='fs-14 course-info-txt fw-5'> Schedule : {schedule}</span>
              </li>
            </ul>
          </div>
